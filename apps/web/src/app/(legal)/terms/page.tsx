  ...
  return (
    <div className="space-y-8 text-sm leading-7 text-[#d8cbb8]">
      ...
      <section className="space-y-3">
        ...
        <p>
          미리룩은 만 14세 미만 아동을 대상으로 하지 않습니다. 만 14세 미만인
          자는 회원으로 가입할 수 없으며 서비스를 이용할 수 없습니다. 회사가 만
          14세 미만 아동의 가입 사실을 확인한 경우 해당 계정과 개인정보를 지체
          없이 삭제할 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="font-semibold text-[#fffaf1]">
          부적절 콘텐츠·악성 이용자 무관용 정책
        </p>
        <p>
          미리룩은 커뮤니티 내 <b>부적절한 콘텐츠(불법·음란·혐오·차별·폭력·
          괴롭힘·명예훼손·사칭 등)와 다른 이용자를 괴롭히는 악성 이용자에 대해
          어떠한 관용도 두지 않습니다(무관용).</b> 회원이 커뮤니티를 이용하려면
          본 정책에 동의해야 하며, 위반 시 사전 통지 없이 콘텐츠가 삭제되고
          이용이 제한·종료될 수 있습니다.
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            부적절한 표현은 게시·댓글 작성 시 자동 필터로 1차 차단되며, 걸러지지
            않은 콘텐츠는 신고를 통해 조치됩니다.
          </li>
          <li>
            모든 게시물에는 <b>신고</b> 기능이 제공되며, 회원은 부적절한 콘텐츠를
            즉시 신고할 수 있습니다. 신고가 누적된 콘텐츠는 자동으로 노출이
            중단됩니다.
          </li>
          <li>
            회원은 특정 이용자를 <b>차단</b>할 수 있습니다. 차단하면 해당 이용자의
            게시물이 내 피드에서 즉시 사라지고, 차단 사실은 운영자에게 통지됩니다.
          </li>
          <li>
            회사는 신고된 부적절 콘텐츠를 확인하는 즉시(늦어도 24시간 이내)
            해당 콘텐츠를 삭제하고 위반 이용자의 이용을 제한·차단합니다.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          jipsa.admin@gmail.com 또는 010-2704-5672로 접수할 수 있습니다.
        </p>
        <p className="text-[#b8aa95]">
          상호: 엠제이인사이트 주식회사 · 대표: 이민재 · 사업자등록번호:
          226-81-56027 · 통신판매업신고: 제2026-부천소사-0462호 · 소재지:
          경기도 부천시 소사구 소삼로 62.
        </p>
      </section>
    </div>
